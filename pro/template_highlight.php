<div id="highlight" class="fix">
	...
	<div class="fcontent fix">
		<?php if(m_pagelines('featuretitle', $post->ID)):?>
			<h1 class="ftitle"><?php echo do_shortcode(m_pagelines('featuretitle', $post->ID));?></h1>
		<?php elseif(m_pagelines('highlight_title', $post->ID)):?>
			<h1 class="ftitle"><?php echo do_shortcode(m_pagelines('highlight_title', $post->ID));?></h1>
		<?php endif;?>
		<?php if(m_pagelines('featuretext', $post->ID)):?>
			<?php echo do_shortcode(m_pagelines('featuretext', $post->ID));?>
		<?php elseif(m_pagelines('highlight_text', $post->ID)):?>
			<?php echo do_shortcode(m_pagelines('highlight_text', $post->ID));?></h1>
		<?php endif;?>
	...
	<?php if(m_pagelines('featuremedia', $post->ID)):?>
		<div class="fmedia"><?php echo do_shortcode( m_pagelines('featuremedia', $post->ID));?></div>
	<?php elseif(m_pagelines('highlight_media', $post->ID)):?>
		<?php echo do_shortcode(m_pagelines('highlight_media', $post->ID));?></h1>
	<?php endif;?>
	<div class="clear"></div>
	</div>
</div>
